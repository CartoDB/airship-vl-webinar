...
import { z as rgbBasis, A as cubehelix, B as cubehelixLong, C as rgb, t as linear, n as select, m as event } from './chunk-2f8d3de5.js';
import './chunk-5ffbf53e.js';
...
class Legend {
    ...
    static get style() { return "as-legend{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;margin:0}as-legend .legend-item{display:-ms-flexbox;display:flex;-ms-flex-line-pack:center;align-content:center;-ms-flex-align:center;align-items:center}as-legend .legend-item__box{display:inline-block;width:12px;height:12px;margin:0 4px 0 0}as-legend .legend-item__label{margin:0 8px 0 0}"; }
}
...
function rawDataToStackBarData(data, scale, colorMap, width, margin) {
...
function createLegendData(metadata, colorMap) {
    if (!metadata) {
        return colorMap;
    }
    const legendData = {};
...
var dataService = { getDomain, rawDataToStackBarData, getKeys, createLegendData };

const DURATION = 500;
function drawColumns(svgElement, data, mousemove, mouseleave) {
...
function drawYAxis(container, scale) {
...
var drawService = { drawColumns, drawYAxis };
...
class StackedBarWidget {
    constructor() {
        ...
        this.mouseOver = (data) => {
            ...
            this.tooltip.style.left = `${event$$1.clientX}px`;
            this.tooltip.style.top = `${event$$1.clientY}px`;
...
export { Legend as AsLegend, StackedBarWidget as AsStackedBarWidget };
